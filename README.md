...
- [l-tail](https://github.com/vs-123/l-tail) -- A memory-efficient, POSIX-compliant, high-performance, log-scanning utility tool for stream monitoring written in C99.
- [dman](https://github.com/vs-123/dman) -- An efficient, POSIX-compliant, policy-based directory-pruning utility tool written in C99
- [qenv](https://github.com/vs-123/qenv) -- A simple, POSIX-compliant, zero-dependency environment variable inspection utility tool designed for quick and memory-efficient filtering across diverse shell environments.
