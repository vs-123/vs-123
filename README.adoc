...
* **Regex** {em} Beyond just using it, I've implemented a PCRE-compatible engine called [regen](https://github.com/vs-123/regen) from scratch in C99, in order to understand how it works deep under the hood. This has given me deep insights on not just regex, but also non-finite automata and backtracking
...
* **Python** {em} I use Python as a scripting language, as a glue language. I use it mostly for writing quick scripts that are slightly more complex for bash, quick prototypes of algorithms, visualising data and making statistical observations and verification, like that of [ystar](https://github.com/vs-123/ystar)
