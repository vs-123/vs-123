...
* https://github.com/vs-123/regen[regen,window=_blank] -- A PCRE-compatible, regular-expressions engine written in C99. Supports various features including capture groups, backreferences, zero-width lookaround assertions, character classes, and more. No external libraries were used
* https://github.com/vs-123/ystar[ystar,window=_blank] -- A xorshift64* PRNG implementation in C99 **with my own custom constants**, tested and verified with various statistical tests including **Wald-Wolfowitz Runs Test** and **Lag-1 Correlation Test**. **PLOTS AVAILABLE IN README**
* https://github.com/vs-123/bpvm[bpvm,window=_blank] -- A simple, fully-functional https://esolangs.org/wiki/BytePusher[BytePusher,window=_blank] VM implementation in C99. **SCREENSHOTS AVAILABLE IN README**
* https://github.com/vs-123/halloc[halloc,window=_blank] -- A dead-simple, thread-safe, general-purpose, explicit-freelist heap allocator library written in C99
* https://github.com/vs-123/barc[barc,window=_blank] -- A lexicographical permutation-based BWT + local frequency-adaptive MTF transform + multi-byte chunked RLE file-compressor archive utility tool written in C99. This project uses no OS-specific/POSIX/external libraries in order to keep it portable
* https://github.com/vs-123/l-tail[l-tail,window=_blank] -- A memory-efficient, POSIX-compliant, high-performance, log-scanning utility tool for stream monitoring written in C99.
* https://github.com/vs-123/dman[dman,window=_blank] -- An efficient, POSIX-compliant, policy-based directory-pruning utility tool written in C99
* https://github.com/vs-123/qenv[qenv,window=_blank] -- A simple, POSIX-compliant, zero-dependency environment variable inspection utility tool designed for quick and memory-efficient filtering across diverse shell environments.
* https://github.com/vs-123/mbf[mbf,window=_blank] -- A custom https://en.wikipedia.org/wiki/Brainfuck[BF,window=_blank] implementation, with the addition of **macros**
* https://github.com/vs-123/dstr[dstr,window=_blank] -- A dead-simple dynamic-string library written in C89. Supports printf-style formatters for string concatenation, written from scratch
* https://github.com/vs-123/minesweeper-c[mswpr,window=_blank] -- Fully functional Minesweeper implementation in C99, using my own https://github.com/vs-123/ystar[ystar,window=_blank] PRNG for mine generation and placement. **Screenshots available in README**
* https://github.com/vs-123/kernel[kernel,window=_blank] -- A dead-simple kernel written in C99 with LLVM toolchain
* https://github.com/vs-123/tegen[tegen,window=_blank] -- A recursive, stochastic text generator for Rust
* https://github.com/vs-123/auc[auc,window=_blank] -- A cross-platform auto-clicker in C99
* https://github.com/vs-123/royal-hemlock-theme[Royal Hemlock Theme,window=_blank] -- Soothing royal-blue light-theme for Emacs. **Screenshots available in README**
...
!https://github.com/vs-123/vs-123/blob/7d4c2b0872f05f84c4f8910fa5f1ffdd4c00f860/c_std_int.webp[C standard int,window=_blank]
...
| Aspect | Choice  |
| :--- | :--- |
| Environment | https://github.com/vs-123/dotfiles[My Dotfiles,window=_blank] |
| Text Editor | https://github.com/vs-123/dotfiles/tree/main/dot_emacs[Emacs,window=_blank] |
| OS | https://voidlinux.org/[Void Linux,window=_blank] |
| WM | https://github.com/vs-123/dotfiles/tree/main/dot_config/openbox[Openbox,window=_blank] |
| Shell | https://github.com/vs-123/dotfiles/blob/main/dot_zshrc[Zsh,window=_blank] |
