...
* **Emacs** {em} Emacs is my daily-driver as a text editor. I enjoy its highly customisable nature. What stands out for me the most is the idea of it being a "self-documenting editor". I really appreciate its built-in help features, especially `C-h` chords

* **Neovim** {em} Neovim used to be my text editor of choice. I used to use it for programming most of my projects. For quick edits however I use `ed`
...
* **LaTeX & Markdown** {em} These are my tools of choice when it comes to technical documentation and making general notes
