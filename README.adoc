...
:repo-raw: {my-gh-raw}/vs-123/main
:img-c-std: {repo-raw}/c_std_int.webp
:ystar-repo: {my-gh-raw}/ystar/refs/heads/main
:bpvm-repo: {my-gh-raw}/bpvm/refs/heads/main
:mswpr-repo: {my-gh-raw}/minesweeper-c/refs/heads/main
:royal-hemlock-repo: {my-gh-raw}/royal-hemlock-theme/refs/heads/main
...
+
image::{ystar-repo}/prng_analysis.png[ystar Plot, width=450]
* {my-gh}/bpvm[bpvm] {em} A simple, fully-functional https://esolangs.org/wiki/BytePusher[BytePusher] VM implementation in C99. 
+
image::{bpvm-repo}/screenshots/colour_palette_bpvm_vs123.png[BPVM Colour Palette Screenshot, width=75%]
+
.*More Screenshots* (click to expand)
[%collapsible]
====
image::{bpvm-repo}/screenshots/invert_loop_sine_bpvm_vs123.png[Invert Loop Sine, width=75%]

image::{bpvm-repo}/screenshots/kb_test_bpvm_vs123.png[Keyboard Test, width=75%]
image::{bpvm-repo}/screenshots/nyan_cat_bpvm_vs123.png[Nyan Cat, width=75%]

image::{bpvm-repo}/screenshots/scrolling_logo_bpvm_vs123.png[Scrolling Logo, width=75%]
image::{bpvm-repo}/screenshots/sine_scroller_bpvm_vs123.png[Sine Scroller, width=75%]
====
...
+
image::{mswpr-repo}/assets/screenshot.png[mswpr Screenshot, width=75%]
...
+
image::{royal-hemlock-repo}/royal-hemlock-theme.png[Royal Hemlock Theme, width=75%]
...
image:{img-c-std}[C standard int]
...
pass:[<p align="center">] 
image:http://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=vs-123&theme=transparent[Profile Details, width=100%]
pass:[</p>]

pass:[<div align="center">]

image:http://github-profile-summary-cards.vercel.app/api/cards/stats?username=vs-123&theme=transparent[Stats, width=48%]
image:http://github-profile-summary-cards.vercel.app/api/cards/most-commit-language?username=vs-123&theme=transparent[Languages, width=48%]
