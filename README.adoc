...
+
image::{my-gh-raw}/ystar/refs/heads/main/prng_analysis.png[ystar Plot, width=450]
* {my-gh}/bpvm[bpvm] {em} A simple, fully-functional https://esolangs.org/wiki/BytePusher[BytePusher] VM implementation in C99. 
+
image::{my-gh-raw}/bpvm/refs/heads/main/screenshots/colour_palette_bpvm_vs123.png[BPVM Colour Palette Screenshot, width=75%]
+
.*More Screenshots* (click to expand)
[%collapsible]
====
image::{my-gh-raw}/bpvm/refs/heads/main/screenshots/invert_loop_sine_bpvm_vs123.png[Invert Loop Sine, width=75%]

image::{my-gh-raw}/bpvm/refs/heads/main/screenshots/kb_test_bpvm_vs123.png[Keboard Test, width=75%]
image::{my-gh-raw}/bpvm/refs/heads/main/screenshots/nyan_cat_bpvm_vs123.png[Nyan Cat, width=75%]

image::{my-gh-raw}/bpvm/refs/heads/main/screenshots/scrolling_logo_bpvm_vs123.png[Scrolling Logo, width=75%]
image::{my-gh-raw}/bpvm/refs/heads/main/screenshots/sine_scroller_bpvm_vs123.png[Sine Scroller, width=75%]
====
...
+
image::{my-gh-raw}/minesweeper-c/refs/heads/main/assets/screenshot.png[mswpr Screenshot, width=75%]
...
+
image::{my-gh-raw}/royal-hemlock-theme/refs/heads/main/royal-hemlock-theme.png[Royal Hemlock Theme, width=75%]
