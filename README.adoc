...
:royal-hemlock-nvim-repo-raw: {my-gh-raw}/royal-hemlock-theme/refs/heads/main
...
+
image::{royal-hemlock-emacs-repo-raw}/royal-hemlock-theme.png[Royal Hemlock Theme, width=48%]
image::{royal-hemlock-nvim-repo-raw}/royal-hemlock-theme-ss.png[Royal Hemlock Neovim, width=48%]
...
| Text Editor | {my-gh}/dotfiles/tree/main/dot_emacs[Emacs] 
