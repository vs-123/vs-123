...
* **{cpp}** -- {cpp} has been my bridge from high-level abstractions to systems programming. I still use it when the project requires complex architectural patterns or modern abstractions
...
* https://github.com/vs-123/regen[regen] -- A PCRE-compatible, regular-expressions engine written in C99. Supports various features including capture groups, backreferences, zero-width lookaround assertions, character classes, and more. No external libraries were used
* https://github.com/vs-123/ystar[ystar] -- A xorshift64* PRNG implementation in C99 **with my own custom constants**, tested and verified with various statistical tests including **Wald-Wolfowitz Runs Test** and **Lag-1 Correlation Test**. **PLOTS AVAILABLE IN README**
* https://github.com/vs-123/bpvm[bpvm] -- A simple, fully-functional https://esolangs.org/wiki/BytePusher[BytePusher] VM implementation in C99. **SCREENSHOTS AVAILABLE IN README**
* https://github.com/vs-123/halloc[halloc] -- A dead-simple, thread-safe, general-purpose, explicit-freelist heap allocator library written in C99
* https://github.com/vs-123/barc[barc] -- A lexicographical permutation-based BWT + local frequency-adaptive MTF transform + multi-byte chunked RLE file-compressor archive utility tool written in C99. This project uses no OS-specific/POSIX/external libraries in order to keep it portable
* https://github.com/vs-123/l-tail[l-tail] -- A memory-efficient, POSIX-compliant, high-performance, log-scanning utility tool for stream monitoring written in C99.
* https://github.com/vs-123/dman[dman] -- An efficient, POSIX-compliant, policy-based directory-pruning utility tool written in C99
* https://github.com/vs-123/qenv[qenv] -- A simple, POSIX-compliant, zero-dependency environment variable inspection utility tool designed for quick and memory-efficient filtering across diverse shell environments.
* https://github.com/vs-123/mbf[mbf] -- A custom https://en.wikipedia.org/wiki/Brainfuck[BF] implementation, with the addition of **macros**
* https://github.com/vs-123/dstr[dstr] -- A dead-simple dynamic-string library written in C89. Supports printf-style formatters for string concatenation, written from scratch
* https://github.com/vs-123/minesweeper-c[mswpr] -- Fully functional Minesweeper implementation in C99, using my own https://github.com/vs-123/ystar[ystar] PRNG for mine generation and placement. **Screenshots available in README**
* https://github.com/vs-123/kernel[kernel] -- A dead-simple kernel written in C99 with LLVM toolchain
* https://github.com/vs-123/tegen[tegen] -- A recursive, stochastic text generator for Rust
* https://github.com/vs-123/auc[auc] -- A cross-platform auto-clicker in C99
* https://github.com/vs-123/royal-hemlock-theme[Royal Hemlock Theme] -- Soothing royal-blue light-theme for Emacs. **Screenshots available in README**
