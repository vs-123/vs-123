...
+
image::{my-gh-raw}/bpvm/refs/heads/main/screenshots/colour_palette_bpvm_vs123.png[BPVM Colour Palette Screenshot, width=450]
+
.More Screenshots (click to expand)
[%collapsible]
====
image::{my-gh-raw}/bpvm/refs/heads/main/screenshots/invert_loop_sine_bpvm_vs123.png[Invert Loop Sine, width=100%]

image::{my-gh-raw}/bpvm/refs/heads/main/screenshots/kb_test_bpvm_vs123.png[Keboard Test, width=100%]
image::{my-gh-raw}/bpvm/refs/heads/main/screenshots/nyan_cat_bpvm_vs123.png[Nyan Cat, width=100%]

image::{my-gh-raw}/bpvm/refs/heads/main/screenshots/scrolling_logo_bpvm_vs123.png[Scrolling Logo, width=100%]
image::{my-gh-raw}/bpvm/refs/heads/main/screenshots/sine_scroller_bpvm_vs123.png[Sine Scroller, width=100%]
====
