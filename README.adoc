...
:royal-hemlock-repo-raw: {my-gh-raw}/royal-hemlock-theme/refs/heads/main
...
* {my-gh}/royal-hemlock-theme[Royal Hemlock Theme] {em} Soothing royal-blue light-theme for Emacs. 
+
image::{royal-hemlock-repo-raw}/royal-hemlock-theme.png[Royal Hemlock Theme, width=75%]
